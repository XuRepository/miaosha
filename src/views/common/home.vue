<template>
  <div class="mod-home">
    <h3>项目背景</h3>
    <ul>
      <li>在电商领域，存在着典型的秒杀业务场景。</li>
      <li>秒杀场景，简单的来说就是一件商品的购买人数远远大于这件商品的库存，而且这件商品在很短的时间内就会被抢购一空的场景。</li>
      <li>每年618、双十一、京东和淘宝大促，很多商品价格较低，库存一定，但客户需求量较大，客户需要在极短的时间抢到需要的商品。</li>
      <li>商家预设固定数量的低价或免单商品，供消费者在指定开始时间购买商品，秒杀系统应需而出。</li>
    ...
    <h3>项目简介</h3>
    <ul>
      <li>从架构视角来看，秒杀系统本质是一个高性能、高一致、高可用的三高系统。</li>
      <li>高性能：秒杀涉及高读和高写的支持，高读就意味着尽量"少读"或"读少"，高写就涉及到数据拆分。</li>
      <li>一致性：秒杀的核心关注是商品库存，有限的商品在同一时间被多个请求同时扣减，而且要保证准确性。</li>
      <li>高可用：分布式系统在运行过程中的情况是非常复杂的，需要考虑如何保障应用在复杂环境下还能高效稳定运行。</li>
    </ul>
    <!-- <h3>获取帮助</h3>
    <ul>
