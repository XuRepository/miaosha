...
import com.hust.miaosha.service.HoutaiTuangouOrderSerivice;
 ...
 */
@Controller
@RequestMapping("/houtaiTuangouOrders")
public class HoutaiTuangouOrderController {
    ...
    @Autowired
    HoutaiTuangouOrderSerivice houtaiOrderSerivice;
    @Autowired
