...
import com.hust.miaosha.service.HoutaiMiaoshaGoodsService;
 ...
 */
@Controller
@RequestMapping("/houtaiMiaoshaGoods")
public class HoutaiMiaoshaGoodsController {
    ...
    @Autowired
    HoutaiMiaoshaGoodsService goodsService;
    @Autowired
